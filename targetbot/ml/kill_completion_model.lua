KillCompletionModel = {}
KillCompletionModel.__index = KillCompletionModel

local MAX_WEIGHT = 10

function KillCompletionModel.new(options)
  options = options or {}
  return setmetatable({
    _weights = {},
    _sampleCount = 0,
...
function KillCompletionModel:predict(features)
...
function KillCompletionModel:observe(success, features)
...
function KillCompletionModel:getSampleCount()
  return self._sampleCount
end

function KillCompletionModel:reset()
  self._weights = {}
  self._sampleCount = 0
end

return KillCompletionModel
