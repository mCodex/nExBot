LureSuccessModel = {}
LureSuccessModel.__index = LureSuccessModel

local MAX_WEIGHT = 10

function LureSuccessModel.new(options)
  options = options or {}
  return setmetatable({
    _weights = {},
    _sampleCount = 0,
...
function LureSuccessModel:predict(features)
...
function LureSuccessModel:observe(success, features)
...
function LureSuccessModel:getSampleCount()
  return self._sampleCount
end

function LureSuccessModel:reset()
  self._weights = {}
  self._sampleCount = 0
end

return LureSuccessModel
