...
do
  local modules = {
    ...
    "ui.modules.workflows.looting",
    "ui.modules.workflows.supplies",
    "ui.modules.workflows",
    "ui.modules.attack",
    "ui.modules.friend_healer",
    "ui.modules.conditions",
    "ui.modules.equipment",
    "ui.modules.dropper",
