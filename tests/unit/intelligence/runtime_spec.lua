describe("intelligence runtime", function()
  it("loads after its dependencies and before feature modules", function()
    ...
    local features = assert(source:find('loadCategory("features"', 1, true))
    assert.is_true(storage < runtime and runtime < features)
  end)
